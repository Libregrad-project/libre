...
bool Currency::getBlockReward(size_t medianSize, size_t currentBlockSize, uint64_t alreadyGeneratedCoins,
  ...
  // const uint64_t TAIL_REWARD = 10 * 100000000;
  const uint64_t TAIL_REWARD = 100000000; // 1 coin
  if (penalizedBaseReward < TAIL_REWARD) {
    reward = TAIL_REWARD + penalizedFee;
    emissionChange = TAIL_REWARD;
  } else {
